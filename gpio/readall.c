...
static char * physNames_SIGE6[64] =
{
	NULL,
	"    3.3V", "5V      ",
	"   SDA.4", "5V      ",
...
static char * physNames_SIGE7s[64] =
{
	NULL,
	"    3.3V", "5V      ",
	"I2C1_SDA", "5V      ",
...
static int physToWpi_SIGE7s[64] =
{
	-1,     //0
	-1, -1, //1,2
	 0, -1, //3,4
...
void OrangePiReadAll(int model)
{
	...
	switch (model)
	{
		...
		case PI_MODEL_SIGE7s:
			printf (" +------+-----+----------+--------+---+  ArmSoM-Sige7s +---+--------+----------+-----+------+\n");
			physToWpi =  physToWpi_SIGE7s;
			physNames =  physNames_SIGE7s;
			alts = alts_rk3588;
			break;
		case PI_MODEL_5_PRO:
			printf (" +------+-----+----------+--------+---+  PI5 PRO +---+--------+----------+-----+------+\n");
		...
		case PI_MODEL_SIGE6:
			printf (" +------+-----+--------+--------+---+   ARMSOM-SIGE6   +---+--------+--------+-----+------+\n");
			physToWpi =  physToWpi_SIGE6;
			physNames =  physNames_SIGE6;
			alts = alts_a527;
			break;
		case PI_MODEL_3B:
			printf (" +------+-----+----------+--------+---+   PI3B   +---+--------+----------+-----+------+\n");
